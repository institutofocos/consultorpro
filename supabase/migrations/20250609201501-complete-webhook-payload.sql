...
-- ATUALIZAÇÃO COMPLETA DO PAYLOAD CONSOLIDADO - INCLUIR TODOS OS CAMPOS

-- Atualizar a função para incluir TODOS os campos do projeto
...
BEGIN
  ...
  -- Buscar TODAS as etapas com TODOS os campos
  SELECT jsonb_agg(
    jsonb_build_object(
      'id', ps.id,
